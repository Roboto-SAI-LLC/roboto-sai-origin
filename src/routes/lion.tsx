...
export const Route = createFileRoute("/lion")({
  ...
  head: () => ({
    meta: [
      { title: `${LION_META.en.title} — ${APP_NAME}` },
      { name: "description", content: LION_META.en.description },
    ],
  }),
});
...
const jsonLd = {
  ...
  headline: `${LION_META.en.title}: ${LION_META.en.subtitle}`,
  alternativeHeadline: LION_META.en.subtitle,
  description: LION_META.en.description,
  ...
  url: `${SITE_URL}/lion`,
  creditText: LION_META.en.credit,
  keywords: [
    "Lion of Judah",
    "Gur Aryeh",
    "Genesis 49:9",
...
function LionPage() {
  ...
  const findings = LION_FINDINGS[lang];
  const sections = LION_SECTIONS[lang];
  const toc = LION_TOC[lang];
      ...
      <main>
        <section className="mx-auto max-w-6xl px-4 pt-10 pb-6 sm:px-6 sm:pt-16">
          <p className="stagger-in font-display text-kicker font-medium tracking-kicker text-subtle uppercase">
            {copy.kicker} · {meta.sourceCount} {copy.sources}
          </p>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 pb-20 sm:px-6 lg:grid-cols-[16rem_1fr]">
          ...
          <article id="article" className="min-w-0 max-w-3xl">
            ...
            <PhotoFigure
              ...
              alt={meta.photoCrouchAlt}
              caption={meta.photoCrouchCaption}
            />
            ...
            {byId("animal") ? (
              <div className="mt-16 border-t border-border pt-12">
                ...
                <PhotoFigure
                  src="/lion/cub.jpg"
                  alt={meta.photoCubAlt}
                  caption={meta.photoCubCaption}
                />
            ...
            {byId("visual") ? (
              <div className="mt-16 border-t border-border pt-12">
                ...
                <PhotoFigure
                  src="/lion/ark.jpg"
                  alt={meta.photoArkAlt}
                  caption={meta.photoArkCaption}
                />
              </div>
            ) : null}
            ...
            <section className="mt-12 rounded-xl bg-surface px-5 py-5 shadow-paper sm:px-6">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted">{LION_CITATION[lang]}</p>
