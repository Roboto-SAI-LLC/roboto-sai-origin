...
export const TEMPLAR_META = {
  en: {
    ...
    citation:
      "Roboto SAI research with a Copilot. “Poor Knights of the Temple.” Roboto SAI Research, September 2026. https://roboto-sai.org/templars",
  ...
  es: {
    ...
    citation:
      "Roboto SAI research with a Copilot. «Pobres caballeros del Templo». Roboto SAI Research, septiembre de 2026. https://roboto-sai.org/templars",
