...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CfKVlrE8.js
...
var CHROME = {
	en: {
		...
		home: {
			...
			briefText: "One page. Five speech tags. No citation numbers. English and Spanish, read by Leo.",
			briefCta: "Listen to the brief",
			chronology: "A brief chronology",
			chronologyLead: "Selected dates that thread Robot, Robert, and the Iberian case studies through the same historical line.",
	...
	es: {
		...
		home: {
			...
			briefText: "Una página. Cinco etiquetas de voz. Sin números de cita. Inglés y español, leídos por Leo.",
			briefCta: "Escuchar la síntesis",
			chronology: "Una cronología breve",
			chronologyLead: "Fechas que atan Robot, Robert y los casos ibéricos a la misma línea histórica.",
			references: "Fuentes",
...
var styles_default = "/assets/styles-Q8j2ZzxR.css";
var APP_NAME = "Robot & Robert";
var DESCRIPTION = "A research essay on the names Robot and Robert, with a 1274 Vila-real network atlas, carta pobla close reading, claim-by-claim dossier, Hebrew lion companion, Templar frontier cut, and a spoken brief in English and Spanish. Roboto SAI research with a Copilot.";
...
var CITATION = "Roboto SAI, with a Copilot. “The Names Robot and Robert: Linguistic Origins, Historical Usage, and Cultural Migrations.” Roboto SAI Research, September 2026.";
var $$splitComponentImporter$5 = () => import("./routes-D3pV5v22.mjs");
var Route$5 = createFileRoute("/")({
	component: lazyRouteComponent($$splitComponentImporter$5, "component"),
	head: () => ({ meta: [{ title: `${META.title} — ${META.journal}` }, {
		name: "description",
		content: META.description
	}] })
});
var $$splitComponentImporter$4 = () => import("./atlas-DcGxK1Xs.mjs");
var Route$4 = createFileRoute("/atlas")({
	component: lazyRouteComponent($$splitComponentImporter$4, "component"),
	head: () => ({ meta: [{ title: `Network atlas — ${META.title}` }, {
		name: "description",
...
function briefNarration(lang) {
	const meta = BRIEF_META[lang];
	return [lang === "en" ? `${meta.title}. A spoken brief from Roboto SAI Research.` : `${meta.title}. Una síntesis hablada de Roboto SAI Research.`, ...BRIEF_TAGS[lang].map((tag, index) => {
		return `${lang === "en" ? `Speech tag ${index + 1}` : `Etiqueta de voz ${index + 1}`}. ${tag.tag}. ${tag.title}. ${tag.body}`;
	})].join("\n\n");
}
function tagNarration(lang, tag) {
	return `${tag.tag}. ${tag.title}. ${tag.body}`;
}
var $$splitComponentImporter$3 = () => import("./brief-X3x-Eiud.mjs");
var Route$3 = createFileRoute("/brief")({
	component: lazyRouteComponent($$splitComponentImporter$3, "component"),
	head: () => ({ meta: [{ title: `${BRIEF_META.en.title} — ${META.journal}` }, {
		name: "description",
...
var $$splitComponentImporter$2 = () => import("./dossier-bvQGNb08.mjs");
var Route$2 = createFileRoute("/dossier")({
	component: lazyRouteComponent($$splitComponentImporter$2, "component"),
	head: () => ({ meta: [{ title: `Dossier — ${META.title}` }, {
		name: "description",
...
var LION_CITATION = "Roboto SAI research with a Copilot. “Gur Aryeh: Hebrew lion symbolism, from Judah’s blessing to a Jewish emblem.” Roboto SAI Research, September 2026.";
var $$splitComponentImporter$1 = () => import("./lion-YQ2JC8hv.mjs");
var Route$1 = createFileRoute("/lion")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	head: () => ({ meta: [{ title: `${LION_META.title} — ${LION_META.journal}` }, {
		name: "description",
...
var TEMPLAR_META = {
	en: {
		...
		citation: "Roboto SAI research with a Copilot. “Poor Knights of the Temple.” Roboto SAI Research, September 2026.",
		chronology: "A brief chronology",
	...
	es: {
		...
		citation: "Roboto SAI research with a Copilot. «Pobres caballeros del Templo». Roboto SAI Research, septiembre de 2026.",
		chronology: "Una cronología breve",
...
var $$splitComponentImporter = () => import("./templars-BQfga5gY.mjs");
var Route = createFileRoute("/templars")({
	component: lazyRouteComponent($$splitComponentImporter, "component"),
	head: () => ({ meta: [{ title: `${TEMPLAR_META.en.title} — ${META.journal}` }, {
		name: "description",
...
//#endregion
export { TIMELINE as A, briefNarration as C, META as D, FINDINGS as E, CHROME as M, pick as N, REFERENCES as O, useLang as P, BRIEF_TAGS as S, CITATION as T, LION_TOC as _, TEMPLAR_SECTIONS as a, REGISTERS as b, BLESSING as c, LION_CITATION as d, LION_FINDINGS as f, LION_TIMELINE as g, LION_SECTIONS as h, TEMPLAR_REFERENCES as i, TOC as j, SECTIONS as k, COMMENTARIES as l, LION_REFERENCES as m, TEMPLAR_FINDINGS as n, TEMPLAR_TIMELINE as o, LION_META as p, TEMPLAR_META as r, TEMPLAR_TOC as s, router_exports as t, LEXICON as u, MERKABAH_FACES as v, tagNarration as w, BRIEF_META as x, PERSONAL_NAMES as y };
