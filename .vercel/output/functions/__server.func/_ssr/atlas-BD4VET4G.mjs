...
//#region node_modules/.nitro/vite/services/ssr/assets/atlas-BD4VET4G.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Interactive dossier · two clocks"
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: tab === "monterrey" ? "A modern migration node: Villarreal saturating Monterrey, the Los Villarreales locality in Salinas Victoria, and La Mansión Villarreal in the centro. Building and gazetteer — not the news cycle." : "People actually named in the Vila-real grants, the neighboring Temple, and the aljama — kept in three columns: in the record, adjacent, not in the record."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
