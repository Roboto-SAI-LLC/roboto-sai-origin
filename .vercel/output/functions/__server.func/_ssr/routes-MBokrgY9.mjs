...
import { a as REFERENCES, c as TOC, i as META, n as CITATION, o as SECTIONS, r as FINDINGS, s as TIMELINE } from "./router-C3ov5RvC.mjs";
import { n as SiteHeader, r as cn, t as ReadingProgress } from "./site-header-BrMIdxHn.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-MBokrgY9.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
					...
					placeholder: "Robot, Peyronet, 1429, carta pobla…",
...
function EtymologyFigure() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								...
								") → Norman given name → kings, saints, surnames."
							]
						})
					]
				})
			...
			children: "Figure 1. Two names that collide in English sound, with unrelated roots and histories."
		})]
	});
}
var TOKEN = /(\*\*[^*]+?\*\*|\*[^*]+?\*|\[\d+\])/g;
...
function TableOfContents({ className }) {
	const [active, setActive] = (0, import_react.useState)(TOC[0]?.id ?? "introduction");
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-display text-kicker font-medium tracking-kicker text-primary uppercase",
							children: "New in this edition"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 max-w-2xl text-sm leading-relaxed text-fg sm:text-base",
							children: "A claim inspector that steelmans first, a clause-by-clause carta pobla, a Plana chronicle that keeps 1429 as a searched gap, four new chapters (XV–XVIII), and a Monterrey migration node on the atlas — hotel, ejido, surname density, no news cycle."
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", {
									className: "min-h-11 cursor-pointer list-none font-display text-sm font-medium text-fg",
									children: "Contents"
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: "A brief chronology"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mb-2 text-article text-muted",
								children: "Selected dates that thread Robot, Robert, and the Iberian case studies through the same historical line."
							}),
