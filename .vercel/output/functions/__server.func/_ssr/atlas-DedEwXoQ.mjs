...
//#region node_modules/.nitro/vite/services/ssr/assets/atlas-DedEwXoQ.js
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: row.layer === "monterrey" ? "Monterrey" : "1269–1274" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: row.year }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: row.kind ? `${kindLabel[row.kind]} · ${row.role}` : row.role })
					] }, `${row.layer}-${row.id}`)) })
				]
			})
		})
...
function RecordLedger() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: layerFilters.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: row.layer === "monterrey" ? "Monterrey" : "1269–1274"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: cn("rounded-full px-2 py-0.5 text-xs font-medium", status[row.status].className),
								children: status[row.status].label
