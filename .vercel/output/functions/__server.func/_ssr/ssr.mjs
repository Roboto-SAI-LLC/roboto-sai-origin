...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-YzR5xAEU.mjs");
...
var manifest = { "0058aabec4daeacb3f4f6d72f2d1d47cbd18cea063988525a47e2089b4721a80": {
	functionName: "askRoVox_createServerFn_handler",
	importer: () => import("./rovox-ask-ChA4Frfh.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-fRnNbUfD.mjs").then((n) => n.t),
